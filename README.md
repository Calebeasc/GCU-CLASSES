...
4. Execute the script:
   ...
   ```
5. Complete the GUI form and click **Run Provisioning**. To script the process instead, pass the corresponding parameters or combine them with `-SkipFoldersAndShares` / `-SkipAclForDepartments` as needed.【F:AllInOne-AD-Setup.ps1†L220-L405】【F:AllInOne-AD-Setup.ps1†L872-L979】
